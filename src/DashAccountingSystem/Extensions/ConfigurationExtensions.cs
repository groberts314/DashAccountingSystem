...
using DashAccountingSystem.Configuration;
using System.Text;
using System.IO;
    ...
    public static class ConfigurationExtensions
    {
        public static LoggerConfiguration ConfigureLogger(this IConfiguration configuration, string appName, string env, out string message)
        {
            ...
            if (loggingConfiguration.LogToRollingFile)
            {
                ...
                loggerConfiguration
                    .WriteTo.RollingFile($"{configuredLogDir}{Path.DirectorySeparatorChar}{appName}-{{Date}}.log", outputTemplate: outputTemplate);
